...
import MobileNamePage from "@/components/MobileNamePageTable/MobileNamePage"
import { jwtDecode } from "jwt-decode"

function MobileNamePageWrapper({ shopId }) {
  return (
...
export default function AllRecordPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      {shopId ? (
        <MobileNamePageWrapper shopId={shopId} />
      ) : (
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 font-medium">Loading mobile registry...</p>
          </div>
        </div>
      )}
    </div>
