...
export default function SalesPricingPage() {
  ...
  const basicPlan = {
    ...
    mongoCategoryId: "Sales",
    description: "Try all features for just ₹99/month",
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-indigo-950 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        ...
        <div className="max-w-6xl mx-auto mb-8 grid md:grid-cols-2 gap-6">
          {/* Premium Plan */}
          <div className="relative backdrop-blur-xl bg-gradient-to-br from-emerald-900/40 via-green-900/40 to-teal-900/40 border-2 border-emerald-500/50 rounded-3xl shadow-2xl overflow-hidden">
